        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-6 text-slate-400 text-lg leading-relaxed">
              <p>
                I'm a <span className="text-slate-200 font-semibold border-b border-blue-500/30">Software Engineer</span> & <span className="text-slate-200 font-semibold border-b border-blue-500/30">AI Engineer</span> based in Surabaya.
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              ...
              <ModuleCard
                icon={<FaBrain />}
                title="AI Engineer"
                stack="Tensorflow, PyTorch, Python, Machine Learning, Deep Learning, RAG"
